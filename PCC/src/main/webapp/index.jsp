					...
					<!-- 1 -->
						<li data-transition="zoomout" data-slotamount="default"
							...
							<div
								...
								style="z-index: 5; white-space: nowrap; letter-spacing: 3.04px; color: #333; font-weight: 700; font-family: '微軟正黑體','Montserrat', sans-serif; text-transform: uppercase;">Postnatal Care Center 
								產後護理中心</div>
							<div
								class="tp-caption NotGeneric-Title tp-resizeme rs-parallaxlevel-0"
								id="slide-layer-2"
								...
								data-start="1000" data-splitin="chars" data-splitout="none"
								data-responsive_offset="on" data-elementdelay="0.05"
								style="z-index: 5; white-space: nowrap; letter-spacing: 1.5px; color: #777; font-weight: normal; font-family: 'Lato', sans-serif;">
								陪您感受生命的喜悅，用 ” 愛 ” 傳遞當下的幸福！ 提供最安心的保護和照護團隊。</div>
							<div
								class="tp-caption NotGeneric-Title tp-resizeme rs-parallaxlevel-0"
								id="slide-layer-3"
								data-x="['center','center','center','center']"
								...
								data-responsive_offset="on" data-elementdelay="0.05"
								style="z-index: 5; white-space: nowrap; letter-spacing: 1.5px; color: #777; font-weight: normal; font-family: 'Lato', sans-serif;">
								全方位的照護、客製化的服務，打造最懂妳的產後護理之家，讓坐月子成為妳與寶寶最美好的蜜月之旅！</div>
							<div
								...
								data-style_hover="c:rgb(255, 255, 255);bg:#EB7C81;"
								...
								style="z-index: 10; padding: 8px 38px; letter-spacing: 0.56px; color: #fff; border-color: #EB7C81; background: #EB7C81; font-family: 'Montserrat', sans-serif; text-transform: uppercase; background-color: #EB7C81; white-space: nowrap; outline: none; box-shadow: none; box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box;">
								更多關於PCC</div></li>
						<!-- 2 -->		
						<li data-transition="zoomout" data-slotamount="default"
							data-easein="easeInOut" data-easeout="easeInOut"
...
<!-- 					<p>our vision is to be Earth's most customer centric company</p> -->
				...
				<div class="col-md-6 col-sm-6 col-xs-6">
					<div class="about-content">
						<h5>
							提供真正契合產婦需求的優質服務創造高滿意度，<span>PCC</span>成為顧客首選信賴品牌及產後護理之家的標竿機構。
						</h5>
						<p>擁有多種的主題風格房型有別一般月子中心，以浪漫輕鬆舒適的設計，質的照顧服務,讓媽咪產後在極佳的空間環境中,有如渡假般的服務享受。</p>
						<p>更有數十位擁有NICU資歷及NRP受訓執照的專業護理人員，採用醫院級的管理模式,期盼每位媽媽及寶貝都能獲得最優質的照顧及服務。</p>
						<p>最的便利購物服務，提供多品項商品特惠價格，搭配各種優惠活動，點數好禮送不完。</p>
						<ul>
							<li>追求母嬰健康安全</li>
							<li>增進親子關係</li>
							<li>提供專業照護</li>
							<li>重視寶寶感覺統合及未來發展潛能開發。</li>
						</ul>
					</div>
				</div>
			</div>
